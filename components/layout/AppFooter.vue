    ...
    <div class="container">
      <div class="footer__top">
        <div class="footer__brand">
          <div class="footer__logo">SHIFT<span class="text-accent">.</span></div>
          <p class="footer__desc text-muted">{{ $t('footer.brand') }}</p>
        </div>
        <div class="footer__cols">
          <div class="footer__col">
            <span class="footer__title">{{ $t('footer.navTitle') }}</span>
            <a href="#about">{{ $t('footer.nav.about') }}</a>
            <a href="#services">{{ $t('footer.nav.services') }}</a>
            <a href="#portfolio">{{ $t('footer.nav.portfolio') }}</a>
            <a href="#pricing">{{ $t('footer.nav.pricing') }}</a>
          </div>
          <div class="footer__col">
